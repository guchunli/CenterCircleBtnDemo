...
@protocol CenterSelectedProtocal <NSObject>
...
@property (nonatomic,weak) id<CenterSelectedProtocal> delegate;
 ...
 */
- (void)loadButtonWithIcons:(NSArray*)icons withSelIcons:(NSArray *)selIcons withTitles:(NSArray*)titles startDegree:(CGFloat)degree layoutDegree:(CGFloat)layoutDegree;
